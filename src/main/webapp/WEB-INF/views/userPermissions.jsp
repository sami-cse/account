...
<div class="panel panel-success">
	...
	<div class="panel-body">
		<form:form method="post" role="form" commandName="permission"
			...
			<%-- <div class="form-group">
				<div class="col-sm-6 col-sm-offset-3">
					<form:select class="form-control" path="userId.id">
						<form:options items="${userLists}" itemLabel="username" itemValue="id"></form:options>
					</form:select>
				</div>
			</div> --%>
			<div class="form-group">
				<div class="col-sm-6 col-sm-offset-3">
					<form:select class="form-control" path="username">
						<form:options items="${userLists}" itemLabel="username" itemValue="username"></form:options>
					</form:select>
				</div>
			</div>
